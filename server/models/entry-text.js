...
module.exports.findNotIndexed = () => (
  db.any('SELECT entry_text.entry_id, entry_text.text, entries.created, entries.user_id, audio.local_path FROM entry_text\
...
module.exports.updateByEntryId = (entryId, column, updatedValue) => (
  db.query('UPDATE entry_text SET $1~ = $2 WHERE entry_id = $3 RETURNING *', [column, updatedValue, entryId])
);
