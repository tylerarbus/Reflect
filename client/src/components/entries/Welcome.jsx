...
const Welcome = () => (
  ...
  >
    ...
    <h3>
      <ul>
        <li>Every day you will recieve a 60 second phone call from us to record how your day went. You can talk about what made you happy, what made you sad, something interesting that happened, or anything else you want to talk about.</li>
        <br/>
